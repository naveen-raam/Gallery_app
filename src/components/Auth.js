            ...
            <Formik
              ...
              validationSchema={Yup.object().shape({
                ...
                mobileNumber: Yup.string()
                  ...
                  .required('Enter a Indian mobile number')
                ...
                password: Yup.string()
                  ...
                  .matches(/(?=(.*\d){2})(?=(.*[a-z]){1})(?=(.*[A-Z]){2})(?=(.*[!@#$%]){2})/, 'Password must contain 2 uppercase, 2 special characters and start with lowercase'),
              ...
              {({
                ...
                <>
                  ...
                  {touched.mobileNumber && errors.mobileNumber && (
                    <Text style={styles.textError}>{errors.mobileNumber}</Text>
                  )}
                  <TextInput
                    style={styles.inputBox}
                    underlineColorAndroid="rgba(0,0,0,0)"
